...
function Content({ homeTitle }) {
  ...
  return (
    <div className="item_box_area">
      <div className="main_item_box" id="myPage">
      ...
      <Container fluid style={{ padding: 0 }}>
        <div className="item_box" id="about">
          ...
          <Row className="item" data-aos="fade-up"></Row>
        </div>
        ...
        <Row className="item_box" id="project">
          <h3 data-aos="fade-up">project</h3>
          <Col className="item" data-aos="fade-up"></Col>
        </Row>
        <Row className="item_box" id="contact">
